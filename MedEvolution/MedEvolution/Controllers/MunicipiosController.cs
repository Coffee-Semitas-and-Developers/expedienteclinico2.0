...
namespace MedEvolution.Controllers
{
    public class MunicipiosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CodigoMunicipio,NombreMun,codigoDepartamento")] Municipio municipio)
        {
            ...
            ViewBag.codigoDepartamento = new SelectList(db.Departamentos, "CodigoDepartamento", "NombreDep", municipio.codigoDepartamento);
            return View(municipio);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CodigoMunicipio,NombreMun,codigoDepartamento")] Municipio municipio)
        {
            if (ModelState.IsValid)
            {
