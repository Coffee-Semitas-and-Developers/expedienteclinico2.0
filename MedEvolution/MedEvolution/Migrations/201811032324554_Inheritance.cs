namespace MedEvolution.Migrations
{
    ...
    public partial class Inheritance : DbMigration
    {
        public override void Up()
        {
            ...
            DropIndex("dbo.Cita", "Medico_Jvpm");
            DropForeignKey("dbo.Cita", "Paciente_IdPaciente", "dbo.Paciente");
            DropIndex("dbo.Cita", "Paciente_IdPaciente");*/
            //DropTable("dbo.Cita");

            CreateTable("dbo.Cita",
                 c => new
                 {
            ...
            AddForeignKey("dbo.Cita", "Medico_Jvpm", "dbo.Medico", principalColumn: "Jvpm", cascadeDelete: false);
            CreateIndex("dbo.Cita", "Medico_Jvpm", unique: false, clustered: false);
            AddForeignKey("dbo.Cita", "Paciente_IdPaciente", "dbo.Paciente", principalColumn: "IdPaciente", cascadeDelete: false);
            CreateIndex("dbo.Cita", "Paciente_IdPaciente", unique: false, clustered: false);

            CreateTable("dbo.Estado",
                c => new
                {
            ...
            CreateTable("dbo.Clinica",
                c => new
                {
                    ...
                    Direccion_Pasaje_calle = c.String(nullable: false, maxLength: 30),
                    Direccion_Casa = c.String(nullable: false, maxLength: 30),
                    Director_IdEmpleado = c.Int(nullable: false),
                })
            ...
            AddForeignKey("dbo.Clinica", "Director_IdEmpleado", "dbo.Empleado", principalColumn: "IdEmpleado", cascadeDelete: true);
            CreateIndex("dbo.Clinica", "Director_IdEmpleado", unique: true, clustered: false);

            CreateTable("dbo.Direccion",
                c => new
                {
            ...
            CreateTable("dbo.EspecialidadDesempeniada",
                c => new
                {
            ...
            CreateTable("dbo.HorarioDeAtencion",
                c => new
                {
            ...
            CreateTable("dbo.ConjuntoSignosVitales",
                c => new
                {
            ...
            AddForeignKey("dbo.Usuario", "Empleado_IdEmpleado", "dbo.Empleado", principalColumn: "IdEmpleado", cascadeDelete: true);
            CreateIndex("dbo.Usuario", "Empleado_IdEmpleado", unique: false, clustered: false);

            CreateTable("dbo.Empleado",
               c => new
               {
               ...
               .ForeignKey("dbo.Clinica", t => t.Clinica_IdClinica, cascadeDelete: false)
               .ForeignKey("dbo.Estado", t => t.Estado_CodigoEstado, cascadeDelete: true)
               .Index(t => t.Dui)
               .Index(t => t.Clinica_IdClinica)
               .Index(t => t.Estado_CodigoEstado);

            CreateTable("dbo.Medico",
                c => new
                {
            ...
            AddForeignKey("dbo.Medico", "Empleado_IdEmpleado", "dbo.Empleado", principalColumn: "IdEmpleado", cascadeDelete: true);
            CreateIndex("dbo.Medico", "Empleado_IdEmpleado", unique: false, clustered: false);

            CreateTable("dbo.Paciente",
                c => new
                {
                    Dui = c.String(nullable: false, maxLength: 10),
                    Estado_CodigoEstado = c.Int(nullable: false),
